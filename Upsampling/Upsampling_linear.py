...
output_file = "30Temmuz_Ampute_linear.xlsx"
time_step = 10  # 10 ms
...
for sheet_name, df in sheets.items():
    ...
    for i, col_name in enumerate(channel_names):
        interp_func = interp1d(time, channels[:, i], kind='linear', fill_value="extrapolate")
...
print(f"linear interpolation completed. Saved to '{output_file}'")
